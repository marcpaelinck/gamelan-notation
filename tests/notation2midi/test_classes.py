...
data_shared_notation_rule = [
    (
        ...
        [RuleValue.SAME_PITCH],
    ),
    (
        Position.PEMADE_SANGSIH,
        [Position.PEMADE_POLOS, Position.PEMADE_SANGSIH],
        [RuleValue.KEMPYUNG, RuleValue.SAME_PITCH],
    ),
    (
        Position.PEMADE_SANGSIH,
...
data_shared_notation = [
    [Tone(Pitch.DONG, 0), P_SANGSIH, GANGSA, Tone(Pitch.DANG, 0)],
    [Tone(Pitch.DENG, 0), P_SANGSIH, GANGSA, Tone(Pitch.DING, 1)],
    [Tone(Pitch.DUNG, 0), P_SANGSIH, GANGSA, Tone(Pitch.DONG, 1)],
    [Tone(Pitch.DANG, 0), P_SANGSIH, GANGSA, Tone(Pitch.DENG, 1)],
    [Tone(Pitch.DING, 1), P_SANGSIH, GANGSA, Tone(Pitch.DUNG, 1)],
    [Tone(Pitch.DONG, 1), P_SANGSIH, GANGSA, Tone(Pitch.DANG, 1)],
    [Tone(Pitch.DENG, 1), P_SANGSIH, GANGSA, Tone(Pitch.DING, 2)],
    [Tone(Pitch.DUNG, 1), P_SANGSIH, GANGSA, Tone(Pitch.DUNG, 1)],
    [Tone(Pitch.DANG, 1), P_SANGSIH, GANGSA, Tone(Pitch.DANG, 1)],
    [Tone(Pitch.DING, 2), P_SANGSIH, GANGSA, Tone(Pitch.DING, 2)],
    [Tone(Pitch.DONG, 0), P_SANGSIH, {K_SANGSIH, P_SANGSIH}, Tone(Pitch.DONG, 0)],
    [Tone(Pitch.DENG, 0), P_SANGSIH, {K_SANGSIH, P_SANGSIH}, Tone(Pitch.DENG, 0)],
    [Tone(Pitch.DUNG, 0), P_SANGSIH, {K_SANGSIH, P_SANGSIH}, Tone(Pitch.DUNG, 0)],
    [Tone(Pitch.DANG, 0), P_SANGSIH, {K_SANGSIH, P_SANGSIH}, Tone(Pitch.DANG, 0)],
    [Tone(Pitch.DING, 1), P_SANGSIH, {K_SANGSIH, P_SANGSIH}, Tone(Pitch.DING, 1)],
    [Tone(Pitch.DONG, 1), P_SANGSIH, {K_SANGSIH, P_SANGSIH}, Tone(Pitch.DONG, 1)],
    [Tone(Pitch.DENG, 1), P_SANGSIH, {K_SANGSIH, P_SANGSIH}, Tone(Pitch.DENG, 1)],
    [Tone(Pitch.DUNG, 1), P_SANGSIH, {K_SANGSIH, P_SANGSIH}, Tone(Pitch.DUNG, 1)],
    [Tone(Pitch.DANG, 1), P_SANGSIH, {K_SANGSIH, P_SANGSIH}, Tone(Pitch.DANG, 1)],
    [Tone(Pitch.DING, 2), P_SANGSIH, {K_SANGSIH, P_SANGSIH}, Tone(Pitch.DING, 2)],
    [Tone(Pitch.DENG, 0), R_1, REYONG, Tone(Pitch.DENG, 0)],
    [Tone(Pitch.DUNG, 0), R_1, REYONG, Tone(Pitch.DUNG, 0)],
    [Tone(Pitch.DANG, 0), R_1, REYONG, Tone(Pitch.DANG, 0)],
    [Tone(Pitch.DING, 1), R_1, REYONG, Tone(Pitch.DUNG, 0)],
    [Tone(Pitch.DONG, 1), R_1, REYONG, Tone(Pitch.DANG, 0)],
    [Tone(Pitch.DENG, 0), R_2, REYONG, Tone(Pitch.DENG, 1)],
    [Tone(Pitch.DUNG, 0), R_2, REYONG, Tone(Pitch.DONG, 1)],
    [Tone(Pitch.DANG, 0), R_2, REYONG, Tone(Pitch.DENG, 1)],
    [Tone(Pitch.DING, 1), R_2, REYONG, Tone(Pitch.DING, 1)],
    [Tone(Pitch.DONG, 1), R_2, REYONG, Tone(Pitch.DONG, 1)],
    [Tone(Pitch.DENG, 0), R_3, REYONG, Tone(Pitch.DING, 2)],
    [Tone(Pitch.DUNG, 0), R_3, REYONG, Tone(Pitch.DUNG, 1)],
    [Tone(Pitch.DANG, 0), R_3, REYONG, Tone(Pitch.DANG, 1)],
    [Tone(Pitch.DING, 1), R_3, REYONG, Tone(Pitch.DING, 2)],
    [Tone(Pitch.DONG, 1), R_3, REYONG, Tone(Pitch.DANG, 1)],
    [Tone(Pitch.DENG, 0), R_3, {R_1, R_3}, Tone(Pitch.DENG, 1)],
    [Tone(Pitch.DUNG, 0), R_3, {R_1, R_3}, Tone(Pitch.DUNG, 1)],
    [Tone(Pitch.DANG, 0), R_3, {R_1, R_3}, Tone(Pitch.DANG, 1)],
    [Tone(Pitch.DING, 1), R_3, {R_1, R_3}, Tone(Pitch.DING, 2)],
    [Tone(Pitch.DONG, 1), R_3, {R_1, R_3}, Tone(Pitch.DONG, 2)],
    [Tone(Pitch.DENG, 0), R_4, REYONG, Tone(Pitch.DENG, 2)],
    [Tone(Pitch.DUNG, 0), R_4, REYONG, Tone(Pitch.DUNG, 2)],
    [Tone(Pitch.DANG, 0), R_4, REYONG, Tone(Pitch.DENG, 2)],
    [Tone(Pitch.DING, 1), R_4, REYONG, Tone(Pitch.DUNG, 2)],
    [Tone(Pitch.DONG, 1), R_4, REYONG, Tone(Pitch.DONG, 2)],
    [Tone(Pitch.DENG, 0), R_4, {R_2, R_4}, Tone(Pitch.DENG, 2)],
    [Tone(Pitch.DUNG, 0), R_4, {R_2, R_4}, Tone(Pitch.DUNG, 2)],
    [Tone(Pitch.DANG, 0), R_4, {R_2, R_4}, Tone(Pitch.DANG, 1)],
    [Tone(Pitch.DING, 1), R_4, {R_2, R_4}, Tone(Pitch.DING, 2)],
    [Tone(Pitch.DONG, 1), R_4, {R_2, R_4}, Tone(Pitch.DONG, 2)],
]
