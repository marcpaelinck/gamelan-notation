...
class NotationParserTester(unittest.TestCase):
    ...
    metadata = [
        ...
        [
            ...
            GoToMeta(
                metatype="GOTO", scope=Scope.GONGAN, line=1, label="PENGAWAK_ANGSEL2", from_beat=-1, passes=[6, 12]
            ),
        ],
        [
        ...
        [
            ...
            PartMeta(metatype="PART", scope=Scope.GONGAN, line=1, name="Pengecet part 2"),
        ],
        ...
        [
            ...
            TempoMeta(
                metatype="TEMPO", scope=Scope.GONGAN, line=1, value=47, first_beat=5, beat_count=3, passes=[1, 2]
            ),
        ],
        [
    ...
    def test_parse_metadata(self):
        for metanotation, expected in self.metadata:
            with self.subTest(notation=metanotation):
                ...
                self.assertEqual(notation.notation_dict[-1][ParserTag.METADATA][0].data, expected)
