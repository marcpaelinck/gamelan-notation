...
from src.common.classes import Beat, Gongan, Measure, Notation
...
class PositionNote:
    ...
    def note(self, **kwargs) -> Note:
        kwargs = {"octave": 1, "stroke": Stroke.OPEN, "note_value": 1} | kwargs
    ...
    @property
    def SILENCE(self):
        return self.note(pitch=Pitch.SILENCE, octave=None, stroke=Stroke.NONE, note_value=1)

    @property
    def EXTENSION(self):
        return self.note(pitch=Pitch.EXTENSION, octave=None, stroke=Stroke.NONE)
...
class TestDictToScoreConverter(BaseUnitTestCase):
    ...
    def test_move_beat_to_start2(self):
        ...
        self.assertEqual(
            converter.score.gongans[0].beats[0].measures[Position.PEMADE_POLOS].passes[-1].generic_notes,
        ...
        self.assertEqual(
            converter.score.gongans[1].beats[0].measures[Position.PEMADE_POLOS].passes[-1].generic_notes,
        ...
        self.assertEqual(
            converter.score.gongans[1].beats[0].measures[Position.KEMPLI].passes[-1].generic_notes,
        ...
        self.assertEqual(
            converter.score.gongans[2].beats[0].measures[Position.PEMADE_POLOS].passes[-1].generic_notes, [P.DUNG]
        )
        self.assertTrue(Position.KEMPLI in converter.score.gongans[2].beats[0].measures.keys())
        self.assertEqual(
            converter.score.gongans[2].beats[0].measures[Position.KEMPLI].passes[-1].generic_notes,
            [Ka.MUTEDSTRIKE],
        )
    ...
    def test_apply_meta(self):
        ...
        tests = [
            ...
            (
                ...
                value := lambda: gongan.beats[0].measures[P.position].passes[DEFAULT].generic_notes,
                expected := [
