...
class TestDictToScoreConverter(BaseUnitTestCase):
    ...
    def test_move_beat_to_start2(self):
        ...
        self.assertEqual(
            converter.score.gongans[0].beats[0].measures[Position.PEMADE_POLOS].passes[-1].notesymbols,
        ...
        self.assertEqual(
            converter.score.gongans[1].beats[0].measures[Position.PEMADE_POLOS].passes[-1].notesymbols,
        ...
        self.assertEqual(
            converter.score.gongans[1].beats[0].measures[Position.KEMPLI].passes[-1].notesymbols,
        ...
        self.assertEqual(
            converter.score.gongans[2].beats[0].measures[Position.PEMADE_POLOS].passes[-1].notesymbols, [P.DUNG]
        )
        self.assertTrue(Position.KEMPLI in converter.score.gongans[2].beats[0].measures.keys())
        self.assertEqual(
            converter.score.gongans[2].beats[0].measures[Position.KEMPLI].passes[-1].notesymbols,
            [Ka.MUTEDSTRIKE],
        )
    ...
    def test_apply_meta(self):
        ...
        tests = [
            ...
            (
                ...
                value := lambda: gongan.beats[0].measures[P.position].passes[DEFAULT].notesymbols,
                expected := [
