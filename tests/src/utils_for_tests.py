...
class PositionNote:
    ...
    def note(self, **kwargs) -> Note:
        ...
        kwargs = {"octave": 1, "effect": Stroke.OPEN, "note_value": 1, "symbol": "", "notesymbol": None} | kwargs
        new_note = Note(position=self.position, **kwargs)
    ...
    @property
    def DONG0(self):
        return self.note(pitch=Pitch.DONG, octave=0, symbol="o,")

    @property
    def DENG0(self):
        return self.note(pitch=Pitch.DENG, octave=0, symbol="e,")

    @property
    def DUNG0(self):
        return self.note(pitch=Pitch.DUNG, octave=0, symbol="u,")

    @property
    def DANG0(self):
        return self.note(pitch=Pitch.DANG, octave=0, symbol="a,")

    @property
    def DING1(self):
        return self.note(pitch=Pitch.DING, symbol="i")

    @property
    def DONG1(self):
        return self.note(pitch=Pitch.DONG, symbol="o")

    @property
    def DONG1MUTED(self):
        return self.note(pitch=Pitch.DONG, stroke=Stroke.MUTED, symbol="o?")

    @property
    def DENG1(self):
        return self.note(pitch=Pitch.DENG, symbol="e")

    @property
    def DUNG1(self):
        return self.note(pitch=Pitch.DUNG, symbol="u")

    @property
    def DANG1(self):
        return self.note(pitch=Pitch.DANG, symbol="a")

    @property
    def DING2(self):
        return self.note(pitch=Pitch.DING, octave=2, symbol="i<")

    @property
    def BYONG(self):
        return self.note(pitch=Pitch.BYONG, octave=None, symbol="b")

    @property
    def BYOT(self):
        return self.note(pitch=Pitch.BYONG, octave=None, stroke=Stroke.ABBREVIATED, symbol="b/")

    @property
    def MUTEDSTRIKE(self):
        return self.note(pitch=Pitch.STRIKE, octave=None, stroke=Stroke.MUTED, symbol="b?")

    @property
    def SILENCE(self):
        return self.note(pitch=Pitch.SILENCE, octave=None, stroke=Stroke.NONE, note_value=0, symbol=".")

    @property
    def EXTENSION(self):
        return self.note(pitch=Pitch.EXTENSION, octave=None, stroke=Stroke.NONE, symbol="-")
