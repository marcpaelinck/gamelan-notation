...
class ScorePostprocessAgent(Agent):
    ...
    def _kempli_beat(cls) -> Note:
        ...
        note = Note(
            ...
            effect=Stroke.MUTED,
            note_value=1.0,
            notesymbol=NoteSymbol(pitch=Pitch.STRIKE, note_value=1, symbol="x"),
            autogenerated=True,
                        ...
                        if beat.id in meta.beats or not meta.beats:
                            for position in meta.positions:
                                ...
                                for pass_seq in meta.passes:
                                    ...
                                    notes = self._create_rest_notes(position, Pitch.EXTENSION, beat.duration)
