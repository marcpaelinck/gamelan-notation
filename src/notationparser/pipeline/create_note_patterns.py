...
from src.notationparser.patterns.rake_pattern import RakePatternGenerator
from src.notationparser.patterns.tremolo_pattern import TremoloPatternGenerator
