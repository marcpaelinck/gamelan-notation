## Modules in the `notationparser` Folder

The `notationparser` folder contains several modules that work together to convert musical notation into MIDI files. Below is a brief explanation of each module:
