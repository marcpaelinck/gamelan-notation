...
class Measure:
    ...
    class Pass:
        ...
        generic_notes: list[GenericNote] = field(default_factory=list)
    ...
    def new(
        ...
        *,
        ...
        return Measure(
            ...
            passes={pass_seq: Measure.Pass(seq=pass_seq, line=line, generic_notes=notes, autogenerated=autogenerated)},
        )

    @computed_field
    @property
    def duration(self) -> float:
        return sum(note.pattern_duration for note in self.passes[DEFAULT].generic_notes)
