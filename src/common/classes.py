...
from src.common.notes import BoundNote, GenericNote
...
class Measure:
    ...
    class Pass:
        ...
        notes: list[GenericNote] = field(default_factory=list)
        boundnotes: list[BoundNote] = None
    ...
    def duration(self) -> float:
        return sum(note.pattern_duration for note in self.passes[DEFAULT].notes)
