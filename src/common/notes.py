...
from src.common.constants import Effect, Octave, Pitch, Position, RuleValue, Stroke
...
class NoteFactory(BaseModel, RunSettingsListener):
    ...
    _POS_P_O_E_TO_NOTE: ClassVar[dict[tuple[Position, Pitch, int, Effect], Note]]
    ...
    def cls_initialize(cls, run_settings: RunSettings):
        ...
        cls._POS_P_O_E_TO_NOTE = {(n.position, n.pitch, n.octave, n.effect): n for n in cls.VALID_NOTES}
    ...
    def clone_note(cls, note: Note, /, **kwargs) -> Note:
        ...
        #     note_value = None
        #     modifiers = []
        #     symbol = cls._NOTE_GENERATOR.normalized_symbol(symbol)
        #     for char in symbol:
