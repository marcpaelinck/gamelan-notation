...
class Note(PatternNote, RunSettingsListener):
    ...
    pattern: list[PatternNote] = Field(default_factory=list)
    ...
    def to_pattern_note(self) -> PatternNote:
        return PatternNote(**self.model_dump())  # pylint: disable=too-many-function-args
